...
def attack_for_agnews(
    ...
    # Use SentenceTransformer to select the connecting phrase that best matches the input text
...
"""
optimize_adversarial_suffix is the core function of the STAIN system, designed to generate adversarial suffixes and append them to the original prompt to mislead the predictions of large language models.
